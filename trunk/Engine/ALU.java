...
public class ALU {
	...
	public void doOperation() throws Exception {
		...
		switch (operation) {
		case 0:
			ALUResult = Integer.toBinaryString(Integer.parseInt(readInput1, 2)
					+ Integer.parseInt(readInput2, 2));
			break;
		case 1:
			ALUResult = Integer.toBinaryString(Integer.parseInt(readInput1, 2)
					| Integer.parseInt(readInput2, 2));
		...
		case 4:
			ALUResult = Integer
					.toBinaryString((Integer.parseInt(readInput1, 2) < Integer
							.parseInt(readInput2, 2)) ? 1 : 0);
			break;
		case 5:
			ALUResult = Integer
					.toBinaryString((Integer.parseInt(readInput1.charAt(0)=='1'?"-"+twoComplement(readInput1):readInput1, 2) < Integer
							.parseInt(readInput2.charAt(0)=='1'?"-"+twoComplement(readInput2):readInput2, 2)) ? 1 : 0);
			break;
		case 6:
			ALUResult = Integer.toBinaryString(~((Integer.parseInt(readInput1,
					2) | Integer.parseInt(readInput2, 2))));
			break;
		default:
	...
	public static void main(String[] args) {
		System.out.println(twoComplement("11111111111"));
	}
}
